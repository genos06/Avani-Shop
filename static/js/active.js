(function ($) {
    ...
    if ($.fn.magnificPopup) {
        // Only apply magnificPopup to portfolio images and product detail images, NOT shop page products
        $('.portfolio-img, .single-product-details .product-img').magnificPopup({
            gallery: {
                enabled: true
            },
            type: 'image'
